...
const Color primaryColor = Color(0xFF0F436B);
const Color secondaryColor = Color(0xFF0067b3);
const Color redColor = Color.fromARGB(255, 254, 4, 4);
const Color whiteColor = Color.fromARGB(255, 255, 255, 255);

MaterialColor primaryColorCustom = MaterialColor(0xFF0F436B, color);
Map<int, Color> color = {
